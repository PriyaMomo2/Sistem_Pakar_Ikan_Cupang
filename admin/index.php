...
<head>
  ...
  <title>Sistem Pakar Ikan Cupang</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <!-- <h4>Dashboard - Admin Diagnosa Penyakit Penyakit Ikan Cupang</h4> -->
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="../assets/images/betta-fish.png" alt="">
        <span class="d-none d-lg-block">Ikan Cupang</span>
      </a>
      <i class="bi bi-list toggle-sidebar-btn"></i>
    </div>
    <div class="container">
      <marquee>Selamat Datang Diaplikasi Sistem Pakar Penyakit Ikan Cupang</marquee>
    </div>
  </header><!-- End Header -->
  ...
  <main id="main" class="main">
    ...
    <section>
      ...
      <br>
      <p>Sistem Pakar penyakit Penyakit Ikan Cupang ini adalah sebuah sistem yang digunakan untuk mendiagnosa awal jenis
        penyakit yang menyerang pada manusia berdasarkan gejala yang dialami. Proses diagnosa dengan menentukan
        gejala-gejala yang terjadi pada manusia, dengan menggunakan metode Dempster Shafer maka sistem dapat memberikan
