...
<body>
  ...
  <section>
    <div class="card mt-4 col-md-7 mx-auto">
      ...
      <h4 class="text-dark d-flex justify-content-center mt-4">Proses Konsultasi Penyakit Penyakit Ikan Cupang</h4>
      <div class="card-body">
        <div class="bg-info rounded-1">
          <h3 class="mt-4 ms-2 p-1">Petunjuk Pengisian</h3>
          <p class="ms-3 me-2 pb-2">Proses konsultasi terdiri dari beberapa pertanyaan. Selanjutnya, anda diminta untuk menjawab dengan cara klik opsi gejalanya apabila gejala tersebut sesuai dengan kondisi yang terjadi. Bacalah dan jawab setiap gejala dengan teliti dan seksama.</p>
        </div>
